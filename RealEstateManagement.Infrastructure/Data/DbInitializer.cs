        ...
        public static void Initialize(AppDbContext context)
        {
            ...
            var houses = new House[]
            {
                new House {
                    ...
                    Price = 8500, SquareMeters = 65, Description = "近大安森林公園，高樓層視野佳", IsActive = true
                },
                new House {
                    Title = "內湖科技園區美寓",
                    City = "台北市", District = "內湖區", DetailAddress = "港墘路",
                    Price = 2300, SquareMeters = 30, Description = "適合上班族，交通便利", IsActive = true
                },
                new House {
                    Title = "信義區捷運小套房",
                    City = "台北市", District = "信義區", DetailAddress = "永吉路",
                    Price = 1250, SquareMeters = 12, Description = "收租自用兩相宜", IsActive = true
                },
                new House {
                    Title = "板橋新站特區",
                    City = "新北市", District = "板橋區", DetailAddress = "縣民大道",
                    Price = 3600, SquareMeters = 45, Description = "三鐵共構，生活機能強", IsActive = true
                },
                new House {
                    Title = "中山區美宅",
                    City = "台北市", District = "中山區", DetailAddress = "林森北路",
                    Price = 1800, SquareMeters = 25, Description = "投資客首選", IsActive = false
                }
            };
